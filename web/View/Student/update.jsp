        ...
        <div class="container-fluid mt-5 bg-light">
            <form action="update" method="POST">
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-3">
                        <input class="form-control" id="name" type="text" name = "name" value="${requestScope.student.name}">
                    </div>
                </div>
                <div class="form-group row mt-3">
                ...
                <div class="form-group row mt-3">
                    ...
                    <div class="col-3">
                        <input class="form-control" id="phoneNumber" type="text" name="phoneNumber" value="${requestScope.student.phoneNumber}">
                    </div>
                </div>
                <div class="form-group row mt-3">
